   ...
   <form class="refreshFrm" id="addExamFrm" method="post">
     <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="col-md-12">
          <div class="form-group">
            <label>Выбирать урок</label>
            <select class="form-control" name="courseSelected">
              <option value="0">Выбирайте уроки</option>
              <?php 
                ...
                { ?>
                  <option value="0">Нет уроки</option>
                <?php }
               ?>
            </select>
          </div>
          ...
          <div class="form-group">
            ...
            <select class="form-control" name="timeLimit" required="">
              <option value="0">Выбирайте время</option>
          ...
          <div class="form-group">
            ...
            <input type="" name="examTitle" class="form-control" placeholder="Название экзамена" required="">
          </div>

          <div class="form-group">
            <label>Немного описание</label>
            <textarea name="examDesc" class="form-control" rows="4" placeholder="Немного описание" required=""></textarea>
          </div>
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary">Дообавить</button>
      </div>
    </div>
   </form>
  </div>
        ...
        <div class="col-md-12">
          ...
          <fieldset>
            ...
            <div class="form-group">
                ...
                <textarea  name="choice_A" id="choice_A" class="form-control" placeholder="Input choice A" autocomplete="off"></textarea>
            </div>

            <div class="form-group">
                <label>Choice B</label>
                <textarea name="choice_B" id="choice_B" class="form-control" placeholder="Input choice B" autocomplete="off"></textarea>
            </div>

            <div class="form-group">
                <label>Choice C</label>
                <textarea name="choice_C" id="choice_C" class="form-control" placeholder="Input choice C" autocomplete="off"></textarea>
            </div>

            <div class="form-group">
                <label>Choice D</label>
                <textarea name="choice_D" id="choice_D" class="form-control" placeholder="Input choice D" autocomplete="off"></textarea>
            </div>

            <div class="form-group">
                <label>Correct Answer</label>
                <textarea name="correctAnswer" id="" class="form-control" placeholder="Input correct answer" autocomplete="off"></textarea>
            </div>
          </fieldset>
        </div>
      </div>
